...
//[06/21/2002]extern PTABLE   ussARCNETTable;
//[06/21/2002]extern PTABLE   ussSLIPTable;
//[06/21/2002]extern PTABLE   ussPPPTable;

/* These #defines provide shorthand names for the above */
#define Ethernet &ussEthernetTable
//[06/21/2002]#define ARCNET   &ussARCNETTable
//[06/21/2002]#define SLIP     &ussSLIPTable
//[06/21/2002]#define PPP      &ussPPPTable

/* =========================================================================
   Adapter level protocols. */

//[06/21/2002]extern PTABLE ussPCITable;
//[06/21/2002]extern PTABLE ussPCMCIA1Table;
//[06/21/2002]extern PTABLE ussPCMCIA2Table;

//[06/21/2002]#define PCI      &ussPCITable
//[06/21/2002]#define PCMCIA1  &ussPCMCIA1Table
//[06/21/2002]#define PCMCIA2  &ussPCMCIA2Table

/* =========================================================================
   Driver level protocols. */

//[06/20/2002]extern PTABLE ussNDISTable;
extern PTABLE ussNE2000Table;
//[06/20/2002]extern PTABLE ussODITable;
extern PTABLE ussWrapTable;

/* More shorthand.  These names are used in netconf.c */
//[06/20/2002]#define NDIS     &ussNDISTable
#define NE2000   &ussNE2000Table
//[06/20/2002]#define ODI      &ussODITable
...
#define GETLONG(w, net) w.c[0] = net[3], w.c[1] = net[2], w.c[2] = net[1], w.c[3] = net[0]
#define PUTLONG(w, net) net[0] = w.c[3], net[1] = w.c[2], net[2] = w.c[1], net[3] = w.c[0]
...
void Install_DHCP(void);	/* [2004/11/21] add*/
...
struct ip {
  struct { unsigned char c[Iid_SZ]; } addr, mask;
};
...
*/
extern long MINTXTOUT; /* For test, about TCP wait ACK timeout & retransmission*/
...
/*
  for 32 socket version lib will return 32,
  for 16 socket version lib will return 16,
  for  8 socket version lib will return  8.
*/

/* [2005/03/31] add for TEST ONLY. */
/*
extern int bCheckInputUdpPacket;
extern int bCheckOutputUdpPacket;
*/
/*
  When set to non-zero, the driver will check the input/output UDP packets.
*/

/* [2006/09/19] add for IP filter */
