; Listing generated by Microsoft (R) Optimizing Compiler Version 17.00.61219.0 
	...
	TITLE	D:\Projects\ASU\ICPDAS\TMMiniOS\TMMiniOS\EEpromSettings.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	??0EEpromSettings@@AAE@XZ			; EEpromSettings::EEpromSettings
PUBLIC	??1EEpromSettings@@AAE@XZ			; EEpromSettings::~EEpromSettings
PUBLIC	?saveToEeprom@EEpromSettings@@SGXPBUPropertiesStruct@@G@Z ; EEpromSettings::saveToEeprom
PUBLIC	?loadFromEeprom@EEpromSettings@@SGPAUPropertiesStruct@@PAG@Z ; EEpromSettings::loadFromEeprom
...
PUBLIC	??_C@_05LBALGACE@tmp?4b?$AA@			; `string'
...
CONST	ENDS
;	COMDAT ??_C@_05LBALGACE@tmp?4b?$AA@
CONST	SEGMENT
??_C@_05LBALGACE@tmp?4b?$AA@ DB 'tmp.b', 00H		; `string'
CONST	ENDS
...
;	COMDAT xdata$x
xdata$x	SEGMENT
__unwindtable$?loadFromEeprom@EEpromSettings@@SGPAUPropertiesStruct@@PAG@Z DD 0ffffffffH
	DD	FLAT:__unwindfunclet$?loadFromEeprom@EEpromSettings@@SGPAUPropertiesStruct@@PAG@Z$0
__ehfuncinfo$?loadFromEeprom@EEpromSettings@@SGPAUPropertiesStruct@@PAG@Z DD 019930522H
	DD	01H
	DD	FLAT:__unwindtable$?loadFromEeprom@EEpromSettings@@SGPAUPropertiesStruct@@PAG@Z
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	DD	00H
	DD	01H
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
;	COMDAT ?loadFromEeprom@EEpromSettings@@SGPAUPropertiesStruct@@PAG@Z
_TEXT	SEGMENT
tv73 = -280						; size = 4
$T2 = -272						; size = 4
$T3 = -260						; size = 4
...
_tmpMask$ = -44						; size = 2
_count$ = -32						; size = 4
_properties$ = -20					; size = 4
__$EHRec$ = -12						; size = 12
_maskOut$ = 8						; size = 4
?loadFromEeprom@EEpromSettings@@SGPAUPropertiesStruct@@PAG@Z PROC ; EEpromSettings::loadFromEeprom, COMDAT
; File d:\projects\asu\icpdas\tmminios\tmminios\eepromsettings.cpp
; Line 60
	push	ebp
	mov	ebp, esp
	push	-1
	push	__ehhandler$?loadFromEeprom@EEpromSettings@@SGPAUPropertiesStruct@@PAG@Z
	mov	eax, DWORD PTR fs:0
	push	eax
...
; Line 68
	...
	push	OFFSET ??_C@_05LBALGACE@tmp?4b?$AA@
...
; Line 70
	...
	push	1
	push	2
	lea	ecx, DWORD PTR _tmpMask$[ebp]
	push	ecx
	...
	call	__RTC_CheckEsp
; Line 71
	mov	eax, DWORD PTR _maskOut$[ebp]
	mov	cx, WORD PTR _tmpMask$[ebp]
	mov	WORD PTR [eax], cx
$LN3@loadFromEe:
; Line 73
	mov	eax, DWORD PTR _maskOut$[ebp]
	...
	test	ecx, ecx
	jle	SHORT $LN2@loadFromEe
; Line 75
	mov	eax, DWORD PTR _maskOut$[ebp]
	movzx	ecx, WORD PTR [eax]
	and	ecx, 1
	je	SHORT $LN1@loadFromEe
; Line 77
	mov	esi, esp
	mov	eax, DWORD PTR _fp$[ebp]
	push	eax
...
; Line 81
	...
	mov	cx, WORD PTR [eax]
	shr	cx, 1
	mov	edx, DWORD PTR _maskOut$[ebp]
	mov	WORD PTR [edx], cx
; Line 82
	jmp	SHORT $LN3@loadFromEe
$LN2@loadFromEe:
; Line 84
	mov	eax, DWORD PTR _maskOut$[ebp]
	mov	cx, WORD PTR _tmpMask$[ebp]
...
; Line 115
	...
	mov	ecx, ebp
	push	eax
	lea	edx, DWORD PTR $LN12@loadFromEe
...
;	COMDAT text$x
text$x	SEGMENT
__unwindfunclet$?loadFromEeprom@EEpromSettings@@SGPAUPropertiesStruct@@PAG@Z$0:
	mov	eax, DWORD PTR $T3[ebp]
	push	eax
	call	??_V@YAXPAX@Z				; operator delete[]
	pop	ecx
	ret	0
__ehhandler$?loadFromEeprom@EEpromSettings@@SGPAUPropertiesStruct@@PAG@Z:
	mov	edx, DWORD PTR [esp+8]
	lea	eax, DWORD PTR [edx+12]
	mov	ecx, DWORD PTR [edx-284]
	xor	ecx, eax
	call	@__security_check_cookie@4
	mov	eax, OFFSET __ehfuncinfo$?loadFromEeprom@EEpromSettings@@SGPAUPropertiesStruct@@PAG@Z
	jmp	___CxxFrameHandler3
text$x	ENDS
?loadFromEeprom@EEpromSettings@@SGPAUPropertiesStruct@@PAG@Z ENDP ; EEpromSettings::loadFromEeprom
; Function compile flags: /Odtp /RTCsu /ZI
;	COMDAT ?saveToEeprom@EEpromSettings@@SGXPBUPropertiesStruct@@G@Z
_TEXT	SEGMENT
_fp$ = -32						; size = 4
_count$ = -20						; size = 4
_tmpMask$ = -8						; size = 2
...
_mask$ = 12						; size = 2
?saveToEeprom@EEpromSettings@@SGXPBUPropertiesStruct@@G@Z PROC ; EEpromSettings::saveToEeprom, COMDAT
; File d:\projects\asu\icpdas\tmminios\tmminios\eepromsettings.cpp
; Line 12
	push	ebp
	mov	ebp, esp
...
; Line 21
	...
	test	eax, eax
	jle	SHORT $LN2@saveToEepr
; Line 23
	movzx	eax, WORD PTR _tmpMask$[ebp]
	and	eax, 1
	je	SHORT $LN1@saveToEepr
; Line 25
	mov	esi, esp
	mov	eax, DWORD PTR _fp$[ebp]
	push	eax
...
; Line 57
	...
	mov	ecx, ebp
	push	eax
	lea	edx, DWORD PTR $LN8@saveToEepr
	call	@_RTC_CheckStackVars@8
	pop	eax
	pop	edx
	pop	edi
...
$LN6@saveToEepr:
	...
	DB	107					; 0000006bH
	DB	0
?saveToEeprom@EEpromSettings@@SGXPBUPropertiesStruct@@G@Z ENDP ; EEpromSettings::saveToEeprom
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
;	COMDAT ??1EEpromSettings@@AAE@XZ
_TEXT	SEGMENT
_this$ = -8						; size = 4
??1EEpromSettings@@AAE@XZ PROC				; EEpromSettings::~EEpromSettings, COMDAT
; _this$ = ecx
; File d:\projects\asu\icpdas\tmminios\tmminios\eepromsettings.cpp
; Line 8
	push	ebp
...
; Line 9
	...
	pop	ebp
	ret	0
??1EEpromSettings@@AAE@XZ ENDP				; EEpromSettings::~EEpromSettings
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
;	COMDAT ??0EEpromSettings@@AAE@XZ
_TEXT	SEGMENT
_this$ = -8						; size = 4
??0EEpromSettings@@AAE@XZ PROC				; EEpromSettings::EEpromSettings, COMDAT
; _this$ = ecx
; File d:\projects\asu\icpdas\tmminios\tmminios\eepromsettings.cpp
; Line 4
	push	ebp
...
; Line 5
	...
	pop	ebp
	ret	0
??0EEpromSettings@@AAE@XZ ENDP				; EEpromSettings::EEpromSettings
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
