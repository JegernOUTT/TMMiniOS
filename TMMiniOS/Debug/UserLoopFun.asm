...
PUBLIC	?UserLoopFun@@YAXXZ				; UserLoopFun
...
EXTRN	?getInstance@CycleController@@SAAAV1@XZ:PROC	; CycleController::getInstance
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
;	COMDAT ?UserLoopFun@@YAXXZ
_TEXT	SEGMENT
_cycleController$ = -8					; size = 4
?UserLoopFun@@YAXXZ PROC				; UserLoopFun, COMDAT
...
; Line 28
	...
	rep stosd
; Line 29
	call	?getInstance@CycleController@@SAAAV1@XZ	; CycleController::getInstance
...
; Line 34
	...
	pop	ebp
	ret	0
?UserLoopFun@@YAXXZ ENDP				; UserLoopFun
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
