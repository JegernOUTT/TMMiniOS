; Listing generated by Microsoft (R) Optimizing Compiler Version 17.00.61219.0 
	...
	TITLE	D:\Projects\ASU\ICPDAS\TMMiniOS\TMMiniOS\UserLoopFun.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?UserLoopFun@@YGXXZ				; UserLoopFun
...
EXTRN	?getInstance@CycleController@@SGAAV1@XZ:PROC	; CycleController::getInstance
EXTRN	?read@CycleController@@QAEXXZ:PROC		; CycleController::read
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
;	COMDAT ?UserLoopFun@@YGXXZ
_TEXT	SEGMENT
_cycleController$ = -8					; size = 4
?UserLoopFun@@YGXXZ PROC				; UserLoopFun, COMDAT
; File d:\projects\asu\icpdas\tmminios\tmminios\userloopfun.cpp
; Line 28
	push	ebp
	mov	ebp, esp
	sub	esp, 204				; 000000ccH
	...
	rep stosd
; Line 29
	call	?getInstance@CycleController@@SGAAV1@XZ	; CycleController::getInstance
	mov	DWORD PTR _cycleController$[ebp], eax
; Line 30
	mov	ecx, DWORD PTR _cycleController$[ebp]
	call	?read@CycleController@@QAEXXZ		; CycleController::read
; Line 34
	pop	edi
	pop	esi
	pop	ebx
	...
	pop	ebp
	ret	0
?UserLoopFun@@YGXXZ ENDP				; UserLoopFun
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
