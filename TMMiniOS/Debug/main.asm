; Listing generated by Microsoft (R) Optimizing Compiler Version 17.00.61219.0 
	...
	TITLE	D:\Projects\ASU\ICPDAS\TMMiniOS\TMMiniOS\main.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?tmpErr@@3HA					; tmpErr
PUBLIC	?tmpArr@@3PAHA					; tmpArr
PUBLIC	?DOValues@@3IA					; DOValues
...
_BSS	SEGMENT
?tmpErr@@3HA DD	01H DUP (?)				; tmpErr
?tmpArr@@3PAHA DD 08H DUP (?)				; tmpArr
?DOValues@@3IA DD 01H DUP (?)				; DOValues
_BSS	ENDS
...
PUBLIC	?ModbusRTU_Master@@YGHHHHHHHHH@Z		; ModbusRTU_Master
PUBLIC	?X304_AnalogIn@@YGMH@Z				; X304_AnalogIn
PUBLIC	?X304_DigitalIn@@YGGXZ				; X304_DigitalIn
PUBLIC	?GetTimeTicks@@YG_JXZ				; GetTimeTicks
PUBLIC	?X304_Init@@YGGXZ				; X304_Init
PUBLIC	?X304_Write_All_DO@@YGXI@Z			; X304_Write_All_DO
PUBLIC	?X304_Read_All_DO@@YGGXZ			; X304_Read_All_DO
PUBLIC	_main
...
EXTRN	?UserInit@@YGXXZ:PROC				; UserInit
EXTRN	?UserLoopFun@@YGXXZ:PROC			; UserLoopFun
...
_TEXT	SEGMENT
_main	PROC						; COMDAT
; File d:\projects\asu\icpdas\tmminios\tmminios\main.cpp
; Line 130
	push	ebp
	mov	ebp, esp
	sub	esp, 192				; 000000c0H
...
; Line 139
	...
	je	SHORT $LN1@main
; Line 141
	call	?UserLoopFun@@YGXXZ			; UserLoopFun
; Line 142
	jmp	SHORT $LN2@main
$LN1@main:
; Line 144
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
;	COMDAT ?X304_Read_All_DO@@YGGXZ
_TEXT	SEGMENT
?X304_Read_All_DO@@YGGXZ PROC				; X304_Read_All_DO, COMDAT
; File d:\projects\asu\icpdas\tmminios\tmminios\main.cpp
; Line 124
	push	ebp
	mov	ebp, esp
...
; Line 126
	...
	pop	ebp
	ret	0
?X304_Read_All_DO@@YGGXZ ENDP				; X304_Read_All_DO
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
;	COMDAT ?X304_Write_All_DO@@YGXI@Z
_TEXT	SEGMENT
_val$ = 8						; size = 4
?X304_Write_All_DO@@YGXI@Z PROC				; X304_Write_All_DO, COMDAT
; File d:\projects\asu\icpdas\tmminios\tmminios\main.cpp
; Line 119
	push	ebp
	mov	ebp, esp
...
; Line 120
	...
	mov	DWORD PTR ?DOValues@@3IA, eax		; DOValues
; Line 121
	pop	edi
	pop	esi
	pop	ebx
	...
	pop	ebp
	ret	4
?X304_Write_All_DO@@YGXI@Z ENDP				; X304_Write_All_DO
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
;	COMDAT ?X304_Init@@YGGXZ
_TEXT	SEGMENT
?X304_Init@@YGGXZ PROC					; X304_Init, COMDAT
; File d:\projects\asu\icpdas\tmminios\tmminios\main.cpp
; Line 114
	push	ebp
	mov	ebp, esp
...
; Line 116
	...
	pop	ebp
	ret	0
?X304_Init@@YGGXZ ENDP					; X304_Init
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
;	COMDAT ?GetTimeTicks@@YG_JXZ
_TEXT	SEGMENT
_time_now$ = -12					; size = 8
?GetTimeTicks@@YG_JXZ PROC				; GetTimeTicks, COMDAT
; File d:\projects\asu\icpdas\tmminios\tmminios\main.cpp
; Line 106
	push	ebp
	mov	ebp, esp
	...
	rep stosd
; Line 108
	lea	eax, DWORD PTR _time_now$[ebp]
	push	eax
	call	_time
	add	esp, 4
; Line 110
	mov	eax, DWORD PTR _time_now$[ebp]
	mov	edx, DWORD PTR _time_now$[ebp+4]
; Line 111
	push	edx
	mov	ecx, ebp
	push	eax
	lea	edx, DWORD PTR $LN5@GetTimeTic
...
$LN3@GetTimeTic:
	...
	DB	119					; 00000077H
	DB	0
?GetTimeTicks@@YG_JXZ ENDP				; GetTimeTicks
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
;	COMDAT ?X304_DigitalIn@@YGGXZ
_TEXT	SEGMENT
?X304_DigitalIn@@YGGXZ PROC				; X304_DigitalIn, COMDAT
; File d:\projects\asu\icpdas\tmminios\tmminios\main.cpp
; Line 101
	push	ebp
	mov	ebp, esp
...
; Line 103
	...
	pop	ebp
	ret	0
?X304_DigitalIn@@YGGXZ ENDP				; X304_DigitalIn
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
;	COMDAT ?X304_AnalogIn@@YGMH@Z
_TEXT	SEGMENT
tv68 = -196						; size = 4
_iCh$ = 8						; size = 4
?X304_AnalogIn@@YGMH@Z PROC				; X304_AnalogIn, COMDAT
; File d:\projects\asu\icpdas\tmminios\tmminios\main.cpp
; Line 96
	push	ebp
	mov	ebp, esp
	...
	rep stosd
; Line 97
	cvtsi2ss xmm0, DWORD PTR _iCh$[ebp]
...
; Line 98
	...
	pop	ebp
	ret	4
?X304_AnalogIn@@YGMH@Z ENDP				; X304_AnalogIn
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
;	COMDAT ?ModbusRTU_Master@@YGHHHHHHHHH@Z
_TEXT	SEGMENT
tv186 = -252						; size = 4
tv145 = -252						; size = 4
_val$ = -52						; size = 16
...
_com$ = 8						; size = 4
_modbusAddress$ = 12					; size = 4
_functionCode$ = 16					; size = 4
_to$ = 20						; size = 4
_from$ = 24						; size = 4
_howMuch$ = 28						; size = 4
_timeout$ = 32						; size = 4
_mode$ = 36						; size = 4
?ModbusRTU_Master@@YGHHHHHHHHH@Z PROC			; ModbusRTU_Master, COMDAT
; File d:\projects\asu\icpdas\tmminios\tmminios\main.cpp
; Line 19
	push	ebp
	mov	ebp, esp
...
; Line 20
	...
	mov	DWORD PTR _slave$[ebp], eax
; Line 21
	mov	eax, DWORD PTR _to$[ebp]
	add	eax, 1
	push	eax
	push	0
	lea	ecx, DWORD PTR _inf$[ebp]
...
; Line 23
	cmp	DWORD PTR ?tmpErr@@3HA, 0		; tmpErr
	jne	$LN14@ModbusRTU_
; Line 25
	mov	DWORD PTR ?tmpErr@@3HA, 502		; tmpErr, 000001f6H
; Line 26
	mov	eax, 4
	imul	eax, 0
	mov	ecx, DWORD PTR _com$[ebp]
	mov	DWORD PTR ?tmpArr@@3PAHA[eax], ecx
; Line 27
	mov	eax, 4
	shl	eax, 0
	mov	ecx, DWORD PTR _modbusAddress$[ebp]
	mov	DWORD PTR ?tmpArr@@3PAHA[eax], ecx
; Line 28
	mov	eax, 4
	shl	eax, 1
	mov	ecx, DWORD PTR _functionCode$[ebp]
	mov	DWORD PTR ?tmpArr@@3PAHA[eax], ecx
; Line 29
	mov	eax, 4
	imul	eax, 3
...
$LN14@ModbusRTU_:
; Line 39
	cmp	DWORD PTR ?tmpErr@@3HA, 502		; tmpErr, 000001f6H
	jne	$LN12@ModbusRTU_
	mov	eax, 4
	imul	eax, 0
	mov	ecx, DWORD PTR ?tmpArr@@3PAHA[eax]
	cmp	ecx, DWORD PTR _com$[ebp]
	je	$LN11@ModbusRTU_
	mov	eax, 4
	shl	eax, 0
	mov	ecx, DWORD PTR ?tmpArr@@3PAHA[eax]
	cmp	ecx, DWORD PTR _modbusAddress$[ebp]
	je	SHORT $LN11@ModbusRTU_
	mov	eax, 4
	shl	eax, 1
	mov	ecx, DWORD PTR ?tmpArr@@3PAHA[eax]
	cmp	ecx, DWORD PTR _functionCode$[ebp]
	je	SHORT $LN11@ModbusRTU_
	mov	eax, 4
	imul	eax, 3
	mov	ecx, DWORD PTR ?tmpArr@@3PAHA[eax]
	...
	shl	eax, 2
	mov	ecx, DWORD PTR ?tmpArr@@3PAHA[eax]
	cmp	ecx, DWORD PTR _from$[ebp]
	je	SHORT $LN11@ModbusRTU_
	mov	eax, 4
	imul	eax, 5
	mov	ecx, DWORD PTR ?tmpArr@@3PAHA[eax]
	cmp	ecx, DWORD PTR _howMuch$[ebp]
	je	SHORT $LN11@ModbusRTU_
	mov	eax, 4
	imul	eax, 6
	mov	ecx, DWORD PTR ?tmpArr@@3PAHA[eax]
	...
	jne	SHORT $LN12@ModbusRTU_
$LN11@ModbusRTU_:
; Line 41
	mov	DWORD PTR ?tmpErr@@3HA, 0		; tmpErr
; Line 43
	jmp	SHORT $LN13@ModbusRTU_
$LN12@ModbusRTU_:
; Line 45
	mov	DWORD PTR ?tmpErr@@3HA, 503		; tmpErr, 000001f7H
$LN13@ModbusRTU_:
; Line 48
	mov	eax, DWORD PTR _functionCode$[ebp]
	mov	DWORD PTR tv145[ebp], eax
	cmp	DWORD PTR tv145[ebp], 2
	je	SHORT $LN7@ModbusRTU_
	cmp	DWORD PTR tv145[ebp], 3
	je	SHORT $LN6@ModbusRTU_
	cmp	DWORD PTR tv145[ebp], 4
	je	$LN5@ModbusRTU_
	jmp	$LN8@ModbusRTU_
$LN7@ModbusRTU_:
; Line 51
	mov	eax, DWORD PTR _inf$[ebp+4]
	sub	eax, 1
	mov	DWORD PTR _inf$[ebp+4], eax
; Line 52
	mov	eax, 4
	imul	eax, 0
	mov	DWORD PTR _val$[ebp+eax], 1
; Line 53
	mov	eax, 4
	shl	eax, 0
	mov	DWORD PTR _val$[ebp+eax], 0
; Line 54
	mov	eax, 4
	shl	eax, 1
	mov	DWORD PTR _val$[ebp+eax], 0
...
; Line 57
	...
	push	eax
	mov	ecx, DWORD PTR _inf$[ebp+4]
	push	ecx
	mov	edx, DWORD PTR _inf$[ebp]
	push	edx
	mov	ecx, DWORD PTR _slave$[ebp]
...
; Line 82
	...
	mov	DWORD PTR _inf$[ebp+4], eax
; Line 83
	mov	eax, DWORD PTR _modbusAddress$[ebp]
	mov	DWORD PTR tv186[ebp], eax
	cmp	DWORD PTR tv186[ebp], 10		; 0000000aH
	je	SHORT $LN1@ModbusRTU_
	jmp	SHORT $LN2@ModbusRTU_
$LN1@ModbusRTU_:
; Line 86
	mov	eax, DWORD PTR _inf$[ebp+4]
	sub	eax, 1
...
$LN2@ModbusRTU_:
; Line 92
	mov	eax, DWORD PTR ?tmpErr@@3HA		; tmpErr
; Line 93
	push	edx
	mov	ecx, ebp
	push	eax
	lea	edx, DWORD PTR $LN20@ModbusRTU_
	call	@_RTC_CheckStackVars@8
	pop	eax
	pop	edx
	pop	edi
...
$LN17@ModbusRTU_:
	...
	DB	102					; 00000066H
	DB	0
?ModbusRTU_Master@@YGHHHHHHHHH@Z ENDP			; ModbusRTU_Master
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
